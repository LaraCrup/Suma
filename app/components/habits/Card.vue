<template>
    <button
        ...
        :class="['w-full relative overflow-hidden flex justify-between rounded-lg p-3 transition-[background-color,transform] duration-150', isCompleted ? 'bg-accent' : 'bg-midlight', isPressed ? 'scale-[0.98]' : 'scale-100']">
        <div
            v-if="showSwipeFill"
